...
<head>
  ...
  <title>Job Portal | Mot de passe oublié</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post" action="send-reset-link.php">
      ...
      <div class="row">
        <div class="col-xs-8">
          <a href="login-candidates.php">Retour à la connexion</a>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
    ...
    if(isset($_SESSION['forgotPasswordMessage'])) {
      ?>
      <div>
        <p class="text-center"><?php echo $_SESSION['forgotPasswordMessage']; ?></p>
      </div>
    <?php
